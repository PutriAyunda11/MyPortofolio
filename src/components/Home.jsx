  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center md:items-start md:p-20">
      ...
      <motion.div
        ...
        className="text-white text-center md:text-left flex flex-col justify-center pt-10 md:pt-0 lg:pt-15"
      >
        <h1 className="text-xl md:text-4xl lg:text-4xl font-extrabold text-lime-400">
      ...
      <motion.div
        ...
        transition={{ duration: 0.6 }}
        className="relative mx-auto md:mx-3 w-[200px] md:w-[280px] lg:w-[350px] lg:left-30"
      >
